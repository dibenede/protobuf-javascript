...
export class Duration extends jspb.Message {
  ...
  toObject(opt_includeInstance) {
    return Duration.toObject(opt_includeInstance, this);
  }
   ...
   *     http://goto/soy-param-migration
   * @param {!Duration} msg The msg instance to transform.
   * @return {!Object}
  ...
  static deserializeBinary(bytes) {
    ...
    var msg = new Duration;
    return Duration.deserializeBinaryFromReader(msg, reader);
  }
   ...
   * @param {!Duration} msg The message object to deserialize into.
