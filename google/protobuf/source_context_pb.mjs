...
export class SourceContext extends jspb.Message {
  ...
  toObject(opt_includeInstance) {
    return SourceContext.toObject(opt_includeInstance, this);
  }
   ...
   *     http://goto/soy-param-migration
   * @param {!SourceContext} msg The msg instance to transform.
   * @return {!Object}
  ...
  static deserializeBinary(bytes) {
    ...
    var msg = new SourceContext;
    return SourceContext.deserializeBinaryFromReader(msg, reader);
  }
   ...
   * @param {!SourceContext} msg The message object to deserialize into.
